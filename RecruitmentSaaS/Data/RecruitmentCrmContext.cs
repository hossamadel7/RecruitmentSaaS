...
public partial class RecruitmentCrmContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Lead>(entity =>
        {
            ...
            entity.HasOne(d => d.GoogleSheet).WithMany(p => p.Leads).HasConstraintName("FK_Leads_GoogleSheet");
        ...
        modelBuilder.Entity<SalesGoogleSheet>(entity =>
        {
            ...
            entity.Property(e => e.SheetName).HasDefaultValue("Sheet1");

            entity.HasOne(d => d.Campaign).WithMany(p => p.SalesGoogleSheets).HasConstraintName("FK_SalesGoogleSheets_Campaign");

            entity.HasOne(d => d.CreatedBy).WithMany(p => p.SalesGoogleSheets).HasConstraintName("FK_SalesGoogleSheets_CreatedBy");
        });
        ...
        modelBuilder.Entity<SalesGoogleSheetUser>(entity =>
        {
            ...
            entity.HasOne(d => d.Sheet).WithMany(p => p.SalesGoogleSheetUsers).HasConstraintName("FK_SheetUsers_Sheet");
        });
